...
switch (_side) do
{
	...
	case civilian:
	{
		...
		_markers = [
					["reb_spawn_1","Abdera RA","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
					["reb_spawn_2","Vikos RA","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
					["reb_spawn_3","Athira","\a3\ui_f\data\map\MapControl\watertower_ca.paa"],
					["reb_spawn_4","Sofia","\a3\ui_f\data\map\MapControl\watertower_ca.paa"]
				];
		};
	...
	{	
		_markers =	[
			...
			["medic_spawn_2","Athira Praxis","\a3\ui_f\data\map\MapControl\hospital_ca.paa"]
		];
	};
};
_markers;