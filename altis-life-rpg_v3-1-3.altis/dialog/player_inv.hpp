...
class playerSettings {
	...
	class controls {
		...
		*/
		...
		class ButtonQuickReply : life_RscButtonMenu {
			idc = 2019;
			text = "QuickReply";
			onButtonClick = "createDialog ""life_quickReply"";";
			x = 0.1 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.805;
			w = (6.25 / 40);
			h = (1 / 25);
		...
		class ButtonGetPlayerCoords : life_RscButtonMenu {
			idc = -1;
			text = "Koords";
			onButtonClick = "hint str(mapGridPosition getPos player);";
			x = 0.26 + (6.25 / 40) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.805;
			w = (6.25 / 40);
			h = (1 / 25);
		};
		class ButtonUniformFix : life_RscButtonMenu {
			idc = 9888;
			text = "UniformFix";
			onButtonClick = "closeDialog 0; [] execVM ""core\cop\uniformFix.sqf"";";
			x = 0.26 + (6.25 / 19.8) + (1 / 250 / (safezoneW / safezoneH));
			y = 0.805;
			w = (6.25 / 40);
			h = (1 / 25);
