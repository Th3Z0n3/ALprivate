...
if(isNull life_trunk_vehicle OR !alive life_trunk_vehicle) exitWith {hint "Das Fahrzeug existiert nicht oder wurde zerstört."};
...
if(_num > _value) exitWith {hint "Das Fahrzeug hat nicht so viele Gegenstände."};
