...
if((lbCurSel 38403) == -1) exitWith {hint "Du musst auch etwas auswaehlen zum Kaufen/Verkaufen!"};
	...
	else
{
	...
	hint parseText format["Du hast %1 fuer <t color='#8cff9b'>%2$ gekauft.</t>",_itemInfo select 1,[_price] call life_fnc_numberText];
	life_cash = life_cash - _price;
};
