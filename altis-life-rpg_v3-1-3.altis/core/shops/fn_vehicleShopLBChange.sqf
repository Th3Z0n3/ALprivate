...
"Kaufpreis: <t color='#8cff9b'>$%2</t><br/>Max Speed: %3 km/h<br/>PS: %4<br/>Sitze: %5<br/>Kapazität: %6<br/>Tank Kapazität: %7<br/>Panzerung: %8",
[_basePrice] call life_fnc_numberText,
[round(_basePrice * 4.6)] call life_fnc_numberText,
