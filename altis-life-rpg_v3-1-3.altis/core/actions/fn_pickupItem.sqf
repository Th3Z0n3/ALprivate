...
{
	titleText[format["Weil du ein %1 als Beweis sichergestellt hast, bekommst du $%2 als Belohnung.",_itemName,[(life_illegal_items select _illegal) select 1] call life_fnc_numberText],"PLAIN"];
