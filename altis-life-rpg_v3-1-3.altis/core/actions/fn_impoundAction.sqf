...
if((_vehicle isKindOf "Car") || (_vehicle isKindOf "Air") || (_vehicle isKindOf "Ship")) then
{
	...
	_upp = "Beschlagnahmung in Vorgang";
	...
	if((count crew _vehicle) == 0) then
	{
		...
		hint format["Du hast ein %1 beschlagnahmt\n\nDafür hast du $%2 erhalten, weil du die Stadt aufgeräumt hältst.",_type,_price];
		[[0,format["%1 hat %2s %3 beschlagnahmt",name player,(_vehicleData select 0) select 1,_vehicleName]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
