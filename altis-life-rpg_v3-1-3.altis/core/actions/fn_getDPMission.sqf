...
life_cur_task setSimpleTaskDescription [format["Du musst dieses Paket nach %1 bringen",toUpper _dp],"Delivery Job",""];
life_cur_task setTaskState "Assigned";
player setCurrentTask life_cur_task;

["DeliveryAssigned",[format["Liefere dieses Paket nach %1",toUpper _dp]]] call bis_fnc_showNotification;
...
[] spawn
{
	...
	if(!alive player) then
	{
		...
		["DeliveryFailed",["Der Auftrag ist fehlgeschlagen, weil du gestorben bist."]] call BIS_fnc_showNotification;
