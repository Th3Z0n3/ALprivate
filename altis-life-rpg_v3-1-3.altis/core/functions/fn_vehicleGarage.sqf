...
if ((player distance cursorTarget) > 5) exitWith {hint "Du bist zu weit weg um diesen NPC zu nutzen."};
if (vehicle player != player) exitWith {hint "Du kannst diesen NPC nicht benutzen während du in einem Auto sitzt."};
