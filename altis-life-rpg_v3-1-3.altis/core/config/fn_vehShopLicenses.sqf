...
switch (life_veh_shop select 0) do
{
	...
	case "civ_car_rent_1": {_ret = license_civ_driver;};
	case "civ_car_rent_2": {_ret = license_civ_driver;};
	case "civ_car_rent_3": {_ret = license_civ_driver;};
	case "civ_car_rent_4": {_ret = license_civ_driver;};
	...
	case "civ_ship_5": {_ret = license_civ_boat;};
	case "civ_ship_6": {_ret = license_civ_boat;};
	case "civ_air_1": {_ret = license_civ_air;};
	case "civ_air_2": {_ret = license_civ_air;};
	case "civ_heli_rent_1": {_ret = license_civ_air;};
	case "civ_heli_rent_2": {_ret = license_civ_air;};
	case "civ_heli_rent_3": {_ret = license_civ_air;};
	...
	case "civ_truck_rent_1":{_ret = license_civ_truck;};
	case "civ_truck_rent_2":{_ret = license_civ_truck;};
	case "civ_truck_rent_3":{_ret = license_civ_truck;};
