...
ctrlSetText[601,format["Bargeld: $%1",[life_cash] call life_fnc_numberText]];

switch (_shop) do
{
	case "reb":
	{
		ctrlSetText[2505,"Stratis Rebellen Shop"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "gun":
	{
		ctrlSetText[2505,"Altis Waffenladen"];
		ctrlShow[2503,false];
		ctrlShow[2513,false];
		ctrlShow[2514,false];
	};
	...
	case "dive":
	{
		ctrlSetText[2505,"Altis Tauchzubehör"];
		ctrlShow[2503,false];
		ctrlShow[2510,false];
		ctrlShow[2511,false];
		ctrlShow[2513,false];
