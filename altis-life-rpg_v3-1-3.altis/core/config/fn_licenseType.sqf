...
switch (_mode) do
{
	case 0:
	{
		switch (_type) do
		{
			...
			case "oildrill": {_var = "license_civ_oildrill"};
			...
			case "shrooms": {_var = "license_civ_shrooms"};
			case "bier": {_var = "license_civ_bier"};
			case "jagdlizenz": {_var = "license_civ_jagdlizenz"};
			case "jackhammer": {_var = "license_civ_jackhammer"};
			case "stahl": {_var = "license_civ_stahl"};
			case "kohle": {_var = "license_civ_kohle"};
	...
	case 1:
	{
		switch (_type) do
		{
			...
			case "license_civ_oildrill": {_var = "oildrill"};
			...
			case "license_civ_shrooms": {_var = "shrooms"};
			case "license_civ_bier": {_var = "bier"};
			case "license_civ_jagdlizenz": {_var = "jagdlizenz"};
			case "license_civ_jackhammer": {_var = "jackhammer"};
			case "license_civ_stahl": {_var = "stahl"};
			case "license_civ_kohle": {_var = "kohle"};
