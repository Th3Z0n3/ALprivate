...
switch (_mode) do
{
	case 0:
	{
		switch (_var) do
		{
			...
			case "shroomsu": {"life_inv_shroomsu"};
			case "shroomsp": {"life_inv_shroomsp"};
			case "bier": {"life_inv_bier"};
			case "hopfen": {"life_inv_hopfen"};
			case "malz": {"life_inv_malz"};
			case "krokodil": {"life_inv_krokodil"};
			case "schlinge": {"life_inv_schlinge"};
			case "krokofleisch": {"life_inv_krokofleisch"};
			case "krokoleder": {"life_inv_krokoleder"};
			case "jackhammer": {"life_inv_jackhammer"};
			case "kohler": {"life_inv_kohler"};
	...
	case 1:
	{
		switch (_var) do
		{
			...
			case "life_inv_shroomsu": {"shroomsu"};
			case "life_inv_shroomsp": {"shroomsp"};
			...
			case "life_inv_krokofleisch": {"krokofleisch"};
			case "life_inv_krokoleder": {"krokoleder"};
			case "life_inv_jackhammer": {"jackhammer"};
			case "life_inv_kohler": {"kohler"};
