...
{
	case 1: {life_paycheck = life_paycheck + 656;};
	case 2: {life_paycheck = life_paycheck + 861;};
	case 3: {life_paycheck = life_paycheck + 1312;};
	case 4: {life_paycheck = life_paycheck + 1925;};
	case 5: {life_paycheck = life_paycheck + 2625;};
	case 6: {life_paycheck = life_paycheck + 3478;};
	case 7: {life_paycheck = life_paycheck + 4970;};
};
