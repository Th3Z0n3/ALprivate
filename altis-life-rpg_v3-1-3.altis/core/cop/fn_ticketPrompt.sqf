...
_control ctrlSetStructuredText parseText format["<t align='center'><t size='.8px'>%1 stellt dir einen Strafzettel mit Bußgeld in Höhe von $%2 bezahlen.",name _cop,_val];
