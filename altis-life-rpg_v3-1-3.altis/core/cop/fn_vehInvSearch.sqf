...
if(_value > 0) then
{
	[[0,format["Ein Auto wurde durchsucht. Dabei wurden illegale Gegenstände im Wert von $%1 beschlagnahmt.",[_value] call life_fnc_numberText]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
	life_atmcash = life_atmcash + _value;
	_vehicle setVariable["Trunk",[],true];
}
	else
{
	hint "Keine illegalen Gegenstände vorhanden.";
};