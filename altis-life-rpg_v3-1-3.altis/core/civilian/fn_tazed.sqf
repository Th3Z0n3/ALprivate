/*
	...
	Update: 08.04.14 (CoopY) Getazerte Spieler bekommen Blurry-Vision / Randomzeit.
*/
...
if(_shooter isKindOf "Man" && alive player) then
{
	if(!life_istazed) then
	{
		...
		[[0,format["%1 wurde von %2 getazert", name _unit, name _shooter]],"life_fnc_broadcast",true,false] spawn life_fnc_MP;
		
		_unit attachTo [_obj,[0,0,0]];

		disableUserInput true;
		
		// Ganz bisschen Randomness bei der Dauer der getazerten Person
		sleep 15 + random 5;
