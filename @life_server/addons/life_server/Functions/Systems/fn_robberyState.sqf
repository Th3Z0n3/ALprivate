...
switch(_state) do
{
	...
	case 0:
	{
		[[2,"Der Bankraub schlug aus unbekannten Gruenden fehl..."],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
	...
	case 1:
	{
		[[1,format["Es wurde $%1 bei dem Bankraub erbeutet.",[_funds] call life_fnc_numberText]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;
		_vault setVariable["fed_locked",true,true];
