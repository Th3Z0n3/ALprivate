...
if((_vInfo select 1) == "cop" && (_vInfo select 2) in ["B_MRAP_01_F","C_SUV_01_F","C_Hatchback_01_sport_F","B_MRAP_01_hmg_F","I_MRAP_03_F","B_Heli_Light_01_F","B_Heli_Transport_01_F","B_Heli_Light_01_armed_F","I_Heli_light_03_unarmed_F"]) then {
