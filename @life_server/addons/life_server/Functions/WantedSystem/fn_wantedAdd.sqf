...
Führen eines Polizeifahrzeugs: 30.000$
Führen eines bewaffneten Fahrzeugs: 50.000$
Falschparken: 500$
Diebstahl von Fahrzeugen: 10.000$
Fahrlässige Tötung mit Fahrzeug: 80.000$ ?
Widerstand mit Gewalt: 20.000$
Führen einer Illegalen Waffe: 15.000,00 € inkl. Beschlagnahmung
*/