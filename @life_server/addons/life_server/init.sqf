...
__CONST__(LIFE_SCHEMA_NAME,"'arma3lifezone'");//CHANGE THIS IF YOUR DATABASE IS NOT CALLED ARMA3LIFE KEEP THE ' '
...
life_random_key = round(random(99999));
publicVariable "life_random_key";

//life_radio_west = radioChannelCreate [[0, 0.95, 1, 0.8], "Side Channel", "%UNIT_NAME", []];
//life_radio_civ = radioChannelCreate [[0, 0.95, 1, 0.8], "Side Channel", "%UNIT_NAME", []];
life_radio_west = radioChannelCreate [[0, 0.95, 1, 0.8], "Polizei Kanal", "(Polizei) %UNIT_NAME", []];
life_radio_civ = radioChannelCreate [[0, 0.95, 1, 0.8], "Zivilisten Kanal", "(Zivilist) %UNIT_NAME", []];
...
//Mapchanges
//if (isServer) then {
//call compile preProcessFileLineNumbers "\life_server\map\building.sqf";
//};